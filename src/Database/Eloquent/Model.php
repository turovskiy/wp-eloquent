...
use Turovskiy\WpEloquent\Database\ConnectionResolverInterface as Resolver;
use Turovskiy\WpEloquent\Database\Eloquent\Relations\BelongsToMany;
use Turovskiy\WpEloquent\Database\Eloquent\Relations\Concerns\AsPivot;
use Turovskiy\WpEloquent\Database\Eloquent\Relations\HasManyThrough;
use Turovskiy\WpEloquent\Database\Eloquent\Relations\Pivot;
...
abstract class Model implements Arrayable, ArrayAccess, Jsonable, JsonSerializable, QueueableEntity
{
     ...
     *
     * @var \Turovskiy\WpEloquent\Database\ConnectionResolverInterface
     */
     ...
     * @return $this
     *
     * @throws \Turovskiy\WpEloquent\Database\Eloquent\MassAssignmentException
     */
     ...
     *
     * @param  \Turovskiy\WpEloquent\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     * @return string
     *
     * @throws \Turovskiy\WpEloquent\Database\Eloquent\JsonEncodingException
     */
     ...
     *
     * @param  \Turovskiy\WpEloquent\Database\Eloquent\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \Turovskiy\WpEloquent\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param  \Turovskiy\WpEloquent\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
